<x-app-layout>
    ...
    <div>
        ...
        <form action="/expert/new-course/new-section/update/{{ $section_id }}" method="POST" class=" items-start">
            @csrf
            ...
            <div class="flex justify-between items-center mt-4 mb-4 w-full">
                ...
                <a href='/expert/new-course/new-section/new-element?course_id={{ $course_id }}&section_id={{ $section_id }}'
