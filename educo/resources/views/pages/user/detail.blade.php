...
<section class="p-20 px-44 box-border">
    ...
    <div class="mt-4">
        <a class="px-3 py-2 bg-blue-400 rounded text-white font-bold" href="{{route('user.detail.edit.index')}}">edit profile</a>
        <a class="px-3 py-2 bg-green-400 rounded text-white font-bold" href="{{route('user.detail.complete.index')}}">complete profile information</a>
    </div>
